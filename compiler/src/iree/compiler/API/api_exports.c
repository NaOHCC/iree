...
extern void mlirExecutionEngineCreate();
extern void mlirExecutionEngineDestroy();
extern void mlirExecutionEngineDumpToObjectFile();
extern void mlirExecutionEngineInvokePacked();
extern void mlirExecutionEngineLookup();
extern void mlirExecutionEngineLookupPacked();
extern void mlirExecutionEngineRegisterSymbol();
...
extern void mlirNVGPUTensorMapDescriptorTypeGet();
...
extern void mlirTypeIsANVGPUTensorMapDescriptorType();
...
uintptr_t __iree_compiler_hidden_force_extern() {
  ...
  x += (uintptr_t)&mlirExecutionEngineCreate;
  x += (uintptr_t)&mlirExecutionEngineDestroy;
  x += (uintptr_t)&mlirExecutionEngineDumpToObjectFile;
  x += (uintptr_t)&mlirExecutionEngineInvokePacked;
  x += (uintptr_t)&mlirExecutionEngineLookup;
  x += (uintptr_t)&mlirExecutionEngineLookupPacked;
  x += (uintptr_t)&mlirExecutionEngineRegisterSymbol;
  ...
  x += (uintptr_t)&mlirNVGPUTensorMapDescriptorTypeGet;
  ...
  x += (uintptr_t)&mlirTypeIsANVGPUTensorMapDescriptorType;
